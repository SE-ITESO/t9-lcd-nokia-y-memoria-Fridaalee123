/*
 * LCD_nokia.c
 * Se definen las funciones que inicializan la pantalla, posicionan el cursor en la pantalla,
 * envian datos y escriben datos.
 *
...
{
	GPIO_PortClear(GPIO_RESET_PIN, 1u << RESET_PIN);	//Secuencia de reinicio de la pantalla
	LCD_nokia_delay();
